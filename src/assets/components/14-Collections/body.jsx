...
export default function Body({ list, isActive }) {
  const { id, save, image, name, rating, about, price, oldPrice, weight } =
    list;
            ...
            <div className="mx-3">
              <div className="d-flex justify-content-between">
                ...
                <div className="">
                  <h5 className="limited__card-by">
                    weight:
                    <span className="limited__card-by--span ms-1">
                      {weight}kg
                    </span>
                  </h5>
                </div>
